...
void USART1_IRQHandler(void)
{
		if (USART_GetITStatus(USART1, USART_IT_RXNE) == SET)
		{
				...
				//USART_SendData(USART1, UsartMessage);
//				if(UsartMessage==0xFA)
//				{
//						if(status == 0)
//						{
//								status = 1;
...
//				else if(status == 3)
//				{
//						RecievedData.LEN = UsartMessage;
//						status = 4;
//				}
//				else if(status == 4)
//				{
//						rxbuf[ccnt++] = UsartMessage;
//						if(ccnt == RecievedData.LEN)
//						{
//								status = 5;
//						}
//				}
//				else if(status == 5)
//				{
//						RecievedData.CHECKSUM = UsartMessage;
//						status = 0;
//						ccnt = 0;
//						packageflag = 1;
//				}
				...
				switch(status)
				{
						case 0:
								...
								break;
						case 1:
								if(UsartMessage==0xFF)
									status = 2;
								else
									status = 0;
								break;
						case 2:
								if(UsartMessage==0x32)
									status = 3;
								else
									status = 0;
								break;
