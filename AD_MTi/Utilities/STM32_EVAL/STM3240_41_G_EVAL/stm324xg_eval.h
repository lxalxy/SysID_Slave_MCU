...
//神舟王测试小板使用
#define EVAL_TEST_COM1                        USART1
#define EVAL_TEST_COM1_STR                    "USART1"
#define EVAL_TEST_COM1_CLK                    RCC_APB2Periph_USART1
#define EVAL_TEST_COM1_TX_PIN                 GPIO_Pin_6
#define EVAL_TEST_COM1_TX_GPIO_PORT           GPIOB
#define EVAL_TEST_COM1_TX_GPIO_CLK            RCC_AHB1Periph_GPIOB
#define EVAL_TEST_COM1_TX_SOURCE              GPIO_PinSource6
#define EVAL_TEST_COM1_TX_AF                  GPIO_AF_USART1
#define EVAL_TEST_COM1_RX_PIN                 GPIO_Pin_7
#define EVAL_TEST_COM1_RX_GPIO_PORT           GPIOB
#define EVAL_TEST_COM1_RX_GPIO_CLK            RCC_AHB1Periph_GPIOB
#define EVAL_TEST_COM1_RX_SOURCE              GPIO_PinSource7
#define EVAL_TEST_COM1_RX_AF                  GPIO_AF_USART1
#define EVAL_TEST_COM1_IRQn                   USART1_IRQn
...
/** @defgroup STM324xG_EVAL_LOW_LEVEL_Exported_Functions
  * @{
  */
void STM_EVAL_LEDInitAll(void);
void STM_EVAL_LEDOffAll(void);
void STM_EVAL_LEDOnAll(void);
void STM_EVAL_LEDInit(Led_TypeDef Led);
void STM_EVAL_LEDOn(Led_TypeDef Led);
void STM_EVAL_LEDOff(Led_TypeDef Led);
void STM_EVAL_LEDToggle(Led_TypeDef Led);
void STM_EVAL_BeepInit(void);
void STM_EVAL_BeepOff(void);
void STM_EVAL_BeepOn(void);
void STM_EVAL_BeepToggle(void);
